  ...
  if (isTr) {
    return [
      // Kuru Buz
      {
        id: "kuru-buz-nedir",
        category: "kuru-buz",
        question: "Kuru buz nedir?",
        answer: "Kuru buz, karbondioksit gazının (CO₂) katı halidir. -78.5°C (-109.3°F) sıcaklığa sahip olup sıvılaşmadan doğrudan gaz haline geçer (süblimleşme). Gıda koruma, medikal lojistik, metal büzme ve endüstriyel kuru buz temizliği kumlama (dry ice blasting) işlemlerinde yaygın olarak kullanılır.",
        keywords: ["kuru buz nedir", "kuru buz", "karbondioksit katı"]
      },
      {
